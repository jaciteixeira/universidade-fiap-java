...
public class TesteController {
	...
	public ModelAndView naoAutorizado() {
		return new ModelAndView("negado");
	}
	...
	public ModelAndView atualizaDiscente(@PathVariable Long id, @Valid Discente discente, 
			BindingResult bd) {
		...
		if(bd.hasErrors()) {
			...
			if(op.isPresent()) {
				...
				dis = discente.toBuilder().setId(dis.getId()).setIdPessoa(dis.getPessoa().getId()).build();
